...
namespace Application.ServiceContracts.IServices
{
    ...
    public interface ITenantService
    {
        ...
        /// </summary>
        /// <param name="tenantCode">The tenant code to lookup (e.g., "SCHOOL001")</param>
        /// <returns>Tenant entity or null if not found</returns>
        ...
        /// </summary>
        /// <returns>True if limit reached, false if under limit</returns>
        Task<bool> HasReachedStudentLimitAsync();

        /// <summary>
        /// Checks if tenant has reached their staff limit
        /// </summary>
        /// <returns>True if limit reached, false if under limit</returns>
        Task<bool> HasReachedStaffLimitAsync();
