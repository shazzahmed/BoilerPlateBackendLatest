...
namespace Domain.Entities
{
   ...
   {
        /// <summary>
        /// Multi-Tenancy: Links this user to a specific school/tenant
        ...
        [JsonIgnore] // Prevent reference loops in caching
        public virtual ICollection<ApplicationUser> Children { get; set; } = new List<ApplicationUser>(); // For parents
        
        public int? StudentId { get; set; } // Link to Student entity (optional)
        
        [ForeignKey("StudentId")]
        [JsonIgnore] // Prevent reference loops in caching
        public Student? Student { get; set; }
        
        public int? StaffId { get; set; } // Link to Staff entity (optional)
