...
{
    public class StaffModel : BaseClass
    {
        ...
        public virtual ICollection<TeacherSubjectsModel>? TeacherSubjects { get; set; }
        public virtual ICollection<ClassTeacherModel>? ClassTeachers { get; set; }
    }
